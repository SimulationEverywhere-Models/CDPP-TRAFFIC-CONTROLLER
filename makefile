...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  lightcontroller.o register.o sensorprocunit.o trafficlight.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
lightcontroller.o: /cygdrive/C/eclipse/workspace/aa/lightcontroller.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/aa/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
sensorprocunit.o: /cygdrive/C/eclipse/workspace/aa/sensorprocunit.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
trafficlight.o: /cygdrive/C/eclipse/workspace/aa/trafficlight.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
lightcontroller.o: \
 /cygdrive/C/eclipse/workspace/aa/lightcontroller.cpp \
 /cygdrive/C/eclipse/workspace/aa/lightcontroller.h \
...
register.o: /cygdrive/C/eclipse/workspace/aa/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/aa/trafficlight.h \
 /cygdrive/C/eclipse/workspace/aa/lightcontroller.h \
 /cygdrive/C/eclipse/workspace/aa/sensorprocunit.h
sensorprocunit.o: /cygdrive/C/eclipse/workspace/aa/sensorprocunit.cpp \
 /cygdrive/C/eclipse/workspace/aa/sensorprocunit.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
